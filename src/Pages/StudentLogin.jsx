...
import studentloginImg from '../assets/Login-student.png'
const StudentLogin = () => {
  const navigate = useNavigate()

  const handleOnStudentLogin =(event)=>{
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-purple-400 via-white to-blue-400 px-4">
          ...
          <div className="max-w-6xl w-full bg-white shadow-2xl rounded-3xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
            ...
            {/* LEFT IMAGE SIDE */}
            <div className="flex items-center justify-center bg-linear-to-br from-indigo-700 to-blue-300 p-10">
            ...
            <div className="p-10 flex items-center justify-center">
              ...
              <form className="w-full max-w-md" onSubmit={handleOnStudentLogin}>
                ...
                <div className="mb-5">
                  ...
                  <div className="input input-bordered flex items-center gap-2 mt-2 rounded-xl">
                    <svg
